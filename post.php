...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_id && !empty($comment)) {
        ...
        $message = "<p> Please log in and enter a comment.</p>";
    }
}
?>

<h2><?= htmlspecialchars($recipe['meal_name']) ?></h2>
<img src="<?= htmlspecialchars($recipe['image_url']) ?>" width="300">
...
<h3>Comments</h3>
<?php
$comments = $db->prepare("SELECT users.username, comments.comment  
                           FROM comments 
